...
class MyCartPoleEnv(gym.Env):
    ...
    def __init__(self):
        ...
        if self.okrender:
            ...
            self.screen_width = 56 #64 #400 #678
    ...
    def reset(self):
        ...
        self.X = random.randint(1, int(self.data.size/2))
    ...
    def step(self, action):
        ...
        return np.array(self.state), reward, self.done, {"bar": self.bar} # , dtype=np.float32
